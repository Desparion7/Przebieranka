...
const Footer = () => {
	...
	return (
		<footer>
			...
			<div className={`${styles['footer-gradient']}`}>
				<p
					className={`relative  mt-8 flex justify-center items-center p-10 text-sm sm:text-xl lg:text-2xl text-center font-semibold h-full w-full lg:mt-3 `}
				>
					Dojeżdżamy tam gdzie jesteśmy potrzebne !
				</p>
				<div
					className={`relative mx-auto p-4 py-6 flex flex-col items-center`}
				>
				...
				<div
					className={`text-center mx-auto p-4 py-5 flex flex-col sm:flex-row  sm:gap-2 justify-center`}
				>
