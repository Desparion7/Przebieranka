	...
	return (
		<>
			<section className='relative xl:mb-5 overflow-hidden pb-5 sm:container mx-auto'>
				<h2 className='text-center text-2xl xl:text-4xl my-[2rem] sm:my-[3rem] font-semibold uppercase'>
				...
				<div className='flex justify-center items-center'>
					...
					<div className='absolute flex w-[85%] custom450:w-[85%] lg:w-[80%] xl:w-[60%]'>
						...
						>
							...
							Komunii. W tej ofercie znajduje się dużo zabaw
							grupowych i integracyjnych oraz zabaw z muzyką. W
							cenie znajduje się pokaz baniek XXL jeśli pogoda
							pozwoli oraz nasz głośnik.
						</p>
					</div>
				</div>
				<div className='sm:container relative mx-auto flex flex-col sm:flex-row justify-center items-center gap-8 my-8 lg:mt-16 p-2 mb-3'>
					<button
			...
			<div className='w-full h-[5rem] my-[1rem] flex justify-center items-center text-center bg-gradient-to-r from-cyan-500 via-cyan-600 to-emerald-400'>
